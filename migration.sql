...
-- CreateTable
CREATE TABLE "CompetitionBlockedSpot" (
    "competitionId" INTEGER NOT NULL,
    "fishingSpotId" INTEGER NOT NULL,

    CONSTRAINT "CompetitionBlockedSpot_pkey" PRIMARY KEY ("competitionId","fishingSpotId")
);
...
-- AddForeignKey
ALTER TABLE "CompetitionBlockedSpot" ADD CONSTRAINT "CompetitionBlockedSpot_competitionId_fkey" FOREIGN KEY ("competitionId") REFERENCES "Competition"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "CompetitionBlockedSpot" ADD CONSTRAINT "CompetitionBlockedSpot_fishingSpotId_fkey" FOREIGN KEY ("fishingSpotId") REFERENCES "FishingSpot"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
